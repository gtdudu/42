...
ClapTrap::ClapTrap( unsigned int e, unsigned int me, std::string n, unsigned int mad,
   unsigned int rad, unsigned int ard ) : _hitPoints( 100 ), _maxHitPoints( 100 ),
_energyPoints( e ), _maxEnergyPoints( me ), _level( 1 ),
